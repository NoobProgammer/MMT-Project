...
def Pay(root, make_payment, on_receive_payment_status):
    ...
    tk.Checkbutton(main_frame, text="pay by card", variable=check_value, onvalue='card', offvalue='none', command=lambda: displayInput(input_bank, 0, 100, 500, 50)).place(x=0, y=50, width=500, height=50)
